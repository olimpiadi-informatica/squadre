    ...
    <div class="row">
      <div class="card bg-light col-lg-5 m-2">
        <div class="card-body">
          ...
          <a href="https://gara.squadre.olinfo.it" class="card-link btn btn-outline-primary">Official contest</a>
        </div>
      </div>
      ...
      <div class="card bg-light col-lg-5 m-2">
        <div class="card-body">
          ...
          <a href="https://mirror.squadre.olinfo.it" class="card-link btn btn-outline-primary">Mirror contest</a>
        </div>
      </div>
    </div>
